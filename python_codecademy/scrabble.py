...
# Define a function called score_word that takes in a parameter word. Inside score_word, create a variable called point_total and set it to 0.
...
# You should get the point value from the letter_to_points dictionary. If the letter you are checking for is not in letter_to_points, add 0 to the point_total. Return point_total
def score_word(word):
    point_total = 0
    for char_as_key in word:
        point_total += letter_to_points.get(char_as_key, 0)
    return point_total
